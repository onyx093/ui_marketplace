...
var ownedAndPurchased = function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    var user, products, ownedProductFileIds, orders, purchasedProductFileIds;
    var req = _b.req;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                ownedProductFileIds = products.map(function (prod) { return prod.product_files; }).flat();
                return [4 /*yield*/, req.payload.find({
                        collection: "orders",
                        depth: 2,
                        where: {
            ...
            case 2:
                ...
                return [2 /*return*/, {
                        id: {
                            in: __spreadArray(__spreadArray([], ownedProductFileIds, true), purchasedProductFileIds, true),
                        },
                    }];
        }
    });
