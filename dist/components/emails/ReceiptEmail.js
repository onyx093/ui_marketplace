...
var ReceiptEmail = function (_a) {
    ...
    var productsTotal = products.reduce(function (total, product) { return total + product.price; }, 0) + 1;
            ...
            React.createElement(components_1.Container, { style: container },
                ...
                React.createElement(components_1.Section, { align: "right" },
                    ...
                    React.createElement(components_1.Column, { style: productPriceLargeWrapper },
                        React.createElement(components_1.Text, { style: productPriceLarge }, (0, utils_1.formatPrice)(productsTotal)))),
...
var ReceiptEmailHTML = function (props) {
    return (0, components_1.render)(React.createElement(ReceiptEmail, __assign({}, props)), { pretty: true });
};
