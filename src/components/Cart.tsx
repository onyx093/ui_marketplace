  ...
  return (
    <Sheet>
      <SheetTrigger className="group -m-2 flex items-center p-2">
        <ShoppingCart
          aria-hidden="true"
          className="w6 h6 flex-shrink-0 text-gray-400 group-hover:text-gray-50"
        />
      ...
      <SheetContent className="w-full flex flex-col pr-0 sm:max-w-lg">
        ...
        {itemCount > 0 ? (
          ...
          <div className="h-full flex flex-col items-center justify-center space-y-1">
            <div
              aria-hidden="true"
              className="relative w-60 h-60 mb-4 text-muted-foreground"
            >
              <Image
                src="/ui-marketplace-empty-cart.png"
                fill
                alt="empty shopping cart ui-marketplace"
              />
            </div>
